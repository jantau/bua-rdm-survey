...
```{r teilen-od, fig.cap="Anteil der Artikel von Forschenden der Charité aus dem Jahr 2020, zu denen Daten offen geteilt wurden"}
open_data %>%
  plot_ly(
  labels = ~type,
  values = ~perc,
